...
import net.superdark.minecraft.mods.encrypteddatatech.fluid.ModFluidTypes;
...
public class EncryptedDataTechMod
{
    ...
    public static class ClientModEvents
    {
        ...
        {
            LOGGER.trace("onClientSetup() :: Called");

            LOGGER.trace("Setting fluids to be transparent when rendering");
            //ItemBlockRenderTypes.setRenderLayer(ModFluids.CrudeOilSource.get(), RenderType.translucent());
            //ItemBlockRenderTypes.setRenderLayer(ModFluids.CrudeOilFlowing.get(), RenderType.translucent());
        }
    }
}
